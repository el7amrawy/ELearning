...
namespace ELearning.Core.Interfaces.Repositories
{
    public interface IBaseRepository<Entity> where Entity : class
	{
		...
		public Task<int> CountAsync(Expression<Func<Entity, bool>> criteria = null, string[] includes = null);
		...
		public Task<Entity> GetByMaxAsync<Property>(Expression<Func<Entity, Property>> selector);
    }
}